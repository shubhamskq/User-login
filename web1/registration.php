...
<?php if (empty($alert)) { ?>
    <form class="form-login" action="" method="post">
        ...
        <input type="number" name="phone" class="btn-in" placeholder="Phone No" class="" maxlength="10" minlength="10" required><br>
        ...
        <input type="checkbox" required>I have read and agree to the terms <br>
        ...
        <div class="row">
            <div class="col-sm-12 text-center">
                ...
                <?php } elseif (isset($alert) && $alert['type'] == 'error') { ?>
                    <img src="<?= base_url('assets/images/failure.gif') ?>" />
                ...
                ?>
                    ...
                    <a href="<?= base_url('registration.php') ?>" class="btn btn-warning">Try Another Phone Number</a>
                <?php
                } ?>
