...
<header>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigationz">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 ml-auto mb-lg-0">
                    ...
                    <?php } else { ?>
                        ...
                        <li>
                            <a class="nav-link active" aria-current="page" href="<?= base_url('registration.php') ?>">Signup</a>
                        </li>
                    <?php } ?>
                ...
                <?php if (isUserLogin()) { ?>
                    <div class="profile_icons">
                        <a href="profile.php" name="profile">
                            <p> <i class="bi bi-person-circle"></i> Profile</p>
                        </a>
                    </div>
                <?php } ?>
            </div>
